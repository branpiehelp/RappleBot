...
void RBOT_rstand(void){//Right stand
  ...
  RBOT_action(90,-1,35,125, 1);//ll lr fl fr dt
  RBOT_action(90,-1,90,125, 1);//ll lr fl fr dt
}
/********************************************//** 
...
@brief 
     ...
     \|  |     |  |     |  |/    |  |
          -   -    -   -        -    -
************************************************/
void RBOT_bwalk(int dt=1){//Back walk
  RBOT_rstep('b',25,25, dt);
  RBOT_lstep('b',25,25, dt);  
}
void RBOT_rwalk(void){//Right walk
  RBOT_action(90,90,60,30,1);//ll lr fl fr dt    
  RBOT_stand();
}
